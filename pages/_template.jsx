...
module.exports = React.createClass({
  ...
  render () {
    const demosActive = includes(this.props.location.pathname, '/demos/')
            ...
            >
              ...
              <Span columns={8} last>
                <a
                  ...
                  href="https://github.com/akollegger/planarium"
                >
                  Github
                </a>
                <Link
                ...
                <Link
                  to={prefixLink('/demos/')}
                  style={{
                    background: demosActive ? activeColors.bg : colors.bg,
                    color: demosActive ? activeColors.fg : colors.fg,
                    float: 'right',
                    textDecoration: 'none',
                    paddingLeft: rhythm(1/2),
                    paddingRight: rhythm(1/2),
